...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Andrei Florea.</span> I'm a{" "}
        <span className="font-bold">Mobile developer</span> with{" "}
        <span className="font-bold">proficient experience</span>. in iOS,
        Android, Javascript and cloud platforms
      </motion.h1>
      ...
      >
        <a
          ...
          href="https://github.com/AndreiFlorea04"
          target="_blank"
        >
